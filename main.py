...
Label(root, text="Samet AKKOYUN", relief="solid", bg="gray99").pack(side=BOTTOM)
...
def info():
    ...
    Label(n, text="Linkdn = https://www.linkedin.com/in/samet-akkoyun-3b29b0170/ ", font=("Helvetica", 10, "bold"),
          bg="gray80", relief="solid").place(x=40, y=40)
    Label(n, text="GitHub = https://github.com/sametAkkoyun ", font=("Helvetica", 10, "bold"),
